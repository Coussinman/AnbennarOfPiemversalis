...
NAI = {
	...
	AGGRESSIVENESS = 3000, -- Base chance (out of 10000) of AI being willing to start a war each diplomatic tick (~1.5 times a month)
	AGGRESSIVENESS_BONUS_EASY_WAR = 900, -- Added to aggressiveness if the war is against a weak or particularily hated enemy
	...
	DEFICIT_SPENDING_MIN_MONTHS = 3, -- AI must have at least this many monthly deficits of savings to be willing to deficit spend
	...
	ARTILLERY_FRACTION = 0.2, 	-- Ratio of artillery to infantry AI will build (doubles after FORCE_COMPOSITION_CHANGE_TECH_LEVEL) (reduced when on tight budget)
	...
	ARMY_BUDGET_FRACTION = 0.9, -- AI will spend a maximum of this fraction of monthly income on army maintenance (based off wartime costs)
	...
	DRILL_BONUS_WAR_READINESS = 0.15,							-- Bonus for war readiness of drilled units
